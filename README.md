...
![Intermediate](https://img.shields.io/badge/difficulty-intermediate-F59E0B) ![Artificial Intelligence](https://img.shields.io/badge/course-Artificial%20Intelligence-0056CE) ![14 hours](https://img.shields.io/badge/estimated-14h-lightgrey)

> **Square 1 AI** starter template — Artificial Intelligence

## Overview

In this intermediate-level project, you'll build a **Knowledge Graph Builder** using Python, spaCy, NetworkX. Extract entities and relationships from text to build a queryable knowledge graph. This is a hands-on project where you'll write real code, solve real problems, and build something you can showcase in your portfolio.
...
```bash
# Clone this template
git clone https://github.com/nikhildesilva-squareai/starter-knowledge-graph-builder.git
cd starter-knowledge-graph-builder
